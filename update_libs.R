...
devtools::install_gitlab("iccat-r-tests/libs/public/iccat.pub.maps",   auth_token = GITLAB_AUTH_TOKEN, dependencies = FALSE)
devtools::install_gitlab("iccat-r-tests/libs/public/iccat.pub.plots",  auth_token = GITLAB_AUTH_TOKEN, dependencies = FALSE)
